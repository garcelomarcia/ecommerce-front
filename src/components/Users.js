...
const Users = () => {
  ...
  useEffect(() => {
    axios
      .get("https://ecommerce-back-3kra.onrender.com/api/user")
      .then((res) => res.data)
  ...
  const handleClick = (e) => {
    ...
    axios
      .put("https://ecommerce-back-3kra.onrender.com/api/user", body)
      .then((res) => res.data)
      .then(() => {
        body.is_admin
  ...
  const handleDelete = (e) => {
    ...
    const email =
      e.target.parentNode.parentNode.parentNode.getElementsByTagName("td")[1]
        .textContent;
    axios
      .delete("https://ecommerce-back-3kra.onrender.com/api/user", {
        headers: {
          email: email,
        },
      })
